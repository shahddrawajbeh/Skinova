...
class _AiSkinScanPageState extends State<AiSkinScanPage>
  ...
  static const String baseUrl = "http://192.168.0.174:5000/api";
                  ...
                  children: [
                    if (isDone) ...[
                      Icon(Icons.check_circle,
                          size: 13,
                          color:
                              isActive ? AppColors.wine : Colors.white),
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed:
                  (allDone && !isAnalyzing) ? onAnalyze : null,
              style: ElevatedButton.styleFrom(
                backgroundColor: AppColors.wine,
                foregroundColor: Colors.white,
                disabledBackgroundColor:
                    AppColors.wine.withOpacity(0.3),
...
class _FaceGuidePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(
        Offset(cx - 12, cy), Offset(cx + 12, cy), crossPaint);
    canvas.drawLine(
        Offset(cx, cy - 12), Offset(cx, cy + 12), crossPaint);
    canvas.drawCircle(
        Offset(cx, cy),
        2.5,
        Paint()
...
class _FaceOverlayPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    canvas.drawOval(
      Rect.fromLTWH(size.width * 0.2, size.height * 0.06,
    ...
    return Scaffold(
      ...
      body: NestedScrollView(
        headerSliverBuilder: (_, __) => [
          ...
          SliverToBoxAdapter(
            child:
                _ExpertAnalysisCard(analysis: r.expertAnalysis),
          ),
...
class _ExpertAnalysisCard extends StatefulWidget {
  ...
  @override
  State<_ExpertAnalysisCard> createState() =>
      _ExpertAnalysisCardState();
}
...
class _RoutineList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView.separated(
      ...
      itemBuilder: (_, i) =>
          _RoutineCard(step: steps[i], isNight: isNight),
    );
  }
}
